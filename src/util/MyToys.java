...
public class MyToys {
    ...
    public static int getAnInteger(String inputMsg, String errorMsg, int minValue) {
        return getAnInteger(inputMsg, errorMsg, minValue, Integer.MAX_VALUE);
    }
    ...
    public static double getDouble(String inputMsg, String errorMsg, double minValue) {
        return getDouble(inputMsg, errorMsg, minValue, Double.MAX_VALUE);
    }
